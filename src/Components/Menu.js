            ...
            <Navbar color="dark" dark expand="md">
                <Container className="d-flex">
                    ...
                    <div className="m-auto p-1 d-flex" >
                        ...
                        <div className="p-1">
                            <a href="/listar-compra" className=" btn btn-outline-light btn-sm">Compras</a>
                        </div>
                        <div className="p-1">
                            <a href="/listar-item-produto" className=" btn btn-outline-light btn-sm">Item-Produtos</a>
                        </div>
                        <div className="p-1">
                            <a href="/listar-produto" className=" btn btn-outline-light btn-sm">Produtos</a>
                        </div>
                    </div>
                </Container>
            </Navbar>
